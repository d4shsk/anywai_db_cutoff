-- =============================================================================
-- anywai_db_cutoff — DDL схемы
-- Предметная область: история диалогов и аналитика AI-чат-сервиса
-- СУБД: PostgreSQL 16
-- =============================================================================

-- Чистый старт. В учебном проекте допустимо; в продакшене так не делают.
...
-- разреженно и неэкономно. JSONB + GIN — компромисс, обоснованный в docs.
-- -----------------------------------------------------------------------------
