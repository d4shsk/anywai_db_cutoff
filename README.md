# Защита курсового проекта по базам данных
...
> Текст выступления. Читаю по разделам, на экране — этот README с картинками и кодом.
> Готовые SQL и ответы на вопросы — в `Шпаргалка.md`.
...
Индексы создавал под конкретные запросы, а не «на всякий случай»:
